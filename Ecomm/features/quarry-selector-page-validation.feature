...
Scenario: Validate all components in the Address Selector modal
  ...
  And I enter "37303" in the Address Input Field
  ...
  And I should see the Address Input Field with zipcode "37303"
...
Scenario: Closing the modal without confirming should NOT save the selected address
 ...
 Given I am on the Address Selector
  ...
  And I enter "23323" in the Address Input Field
  And I select the first address suggestion
  ...
  Scenario: Validate default placeholder when no zipcode is saved
    Given I am on the Address Selector
    When the Modal is displayed
    Then I should see the Address Input Field with zipcode "none"
